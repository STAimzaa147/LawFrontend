...
export default function CasePage() {
  ...
  const fetchClientCases = useCallback(async () => {
    try {
      ...
      if (data.success) {
        setCases(data.data)
        console.log("fetch client case data : ", data.data)
      }
    } catch (error) {
  ...
  const fetchLawyerCases = useCallback(async () => {
    try {
      ...
      if (data.success) {
        setCases(data.data)
        console.log("fetch lawyer case data : ", data.data)
      }
    } catch (error) {
        ...
        <div className="max-w-6xl mx-auto p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="text-gray-300 text-sm">บทบาท:</span>
              <span
        ...
        <div className="flex gap-4 mb-8">
          ...
          {(userRole === "client" || userRole === "user") && (
            <button
              ...
              className="bg-[#C9A55C] text-white px-6 py-3 rounded-full hover:bg-[#C9A55C]/80 transition flex items-center gap-2 font-medium shadow-sm"
            >
                      ...
                      <div className="flex gap-6">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-sm text-gray-600">{personInfo.label}</span>
