...
export default function SearchBar() {
  ...
  const handleSearch = (searchTerm: string) => {
    ...
    setIsFocused(false)
    // Navigate to search results page instead of lawyers page
  ...
  return (
    <form className="p-10 w-[1200px] relative place-self-center z-10" ref={wrapperRef} onSubmit={handleSubmit}>
